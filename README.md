# better-typings-for-css-modules-loader
...
This package was forked from [Jimdo/typings-for-css-modules-loader](https://github.com/Jimdo/typings-for-css-modules-loader) which is out of date. Just adding default export for better use.

----

## Installation

Install via npm `npm install --save-dev better-typings-for-css-modules-loader`
...
e.g.
```js
  { test: /\.css$/, loader: 'better-typings-for-css-modules-loader?modules&namedExport' }
```
...
with:
```js
  { test: /\.css$/, loader: 'better-typings-for-css-modules-loader?modules&namedExport&camelCase' }
```
...
```js
  { test: /\.css$/, loader: 'better-typings-for-css-modules-loader?silent' }
```
...
```js
  { test: /\.css$/, loader: 'better-typings-for-css-modules?banner="// This file is automatically generated by typings-for-css-modules.\n// Please do not change this file!"' }
```

## Usage

Keep your `webpack.config` as is just instead of using `css-loader` use `better-typings-for-css-modules-loader`
...
```js
webpackConfig.module.loaders: [
    { test: /\.css$/, loader: 'better-typings-for-css-modules-loader?modules' }
    { test: /\.scss$/, loader: 'better-typings-for-css-modules-loader?modules&sass' }
];
```
...
Adding the `better-typings-for-css-modules-loader` will generate a file `~/my-project/src/component/MyComponent/myComponent.scss.d.ts` that has the following content:
```ts
...
### Typescript doesn't find the typings
